...
<body>
	<div id="container">
		...
		<div id="body">
			<?php if ($load) { ?>
				<p>Please go to this Url first time to migrate your's database</p>
				<code><a href="/index.php/migrate" target="_blank">Migrate</a></code>
			<?php } ?>
			<p>List users here:</p>
			<code><a href="/index.php/base/user">List users</a></code>
